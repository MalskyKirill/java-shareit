...
class ItemServiceImplTest {
    ...
    static void setUp() {
        ...
        itemDtoWithBookingAndComments = ItemMapper.mapToItemDtoWithBookingAndComments(item, null, null, Collections.emptyList());
    ...
    void getItem() {
        ...
        ItemDtoWithBookingAndComments result = itemService.getItem(1L, 1L);
        assertNotNull(result);
        assertEquals(itemDtoWithBookingAndComments, result);

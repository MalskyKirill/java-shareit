...
public class ItemMapper {
    public static ItemDto mapToItemDto(Item item) {
        ...
        itemDto.setRequestId(item.getItemRequest() == null ? null : item.getItemRequest().getId());
        return itemDto;
    }
    ...
    public static ItemDtoWithBookingAndComments mapToItemDtoWithBookingAndComments(Item item, BookingDtoItem nextBooking, BookingDtoItem lastBooking, List<CommentDtoResponse> comments) {
        ...
        itemDtoWithBookingAndComments.setRequestId(item.getItemRequest() == null ? null : item.getItemRequest().getId());
